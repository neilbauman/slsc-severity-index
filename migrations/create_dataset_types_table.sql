...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_dataset_types_data_type ON dataset_types(data_type);
CREATE INDEX IF NOT EXISTS idx_dataset_types_name ON dataset_types(name);
